...
<html lang="en">
  <head>
    <title>Cycle sharing- Free Bootstrap 4 Template by Colorlib</title>
    <meta charset="utf-8">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html"><img src="{{ asset('images/cyclelogo.jpg') }}" alt="tag" height="50px" width="80px">Cycle sharing</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="{{url('/cycle')}}" class="nav-link">Cycle</a></li>
