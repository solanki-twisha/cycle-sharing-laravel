    			...
    			<div class="col-md-12 ftco-animate">
    				<div class="car-list">
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url(images/cy1.jpg);"></div></td>
						        <td class="product-name">
						        	<h3>Cheverolet SUV Cycle</h3>
						        	<p class="mb-0 rated">
						        		<span>rated:</span>
						        ...
						        <td class="price">
						        	<p class="btn-custom"><a href="#">Rent a cycle</a></p>
						      ...
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url(images/cy2.jpg);"></div></td>
						        <td class="product-name">
						      ...
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url(images/cy3.jpg);"></div></td>
						        <td class="product-name">
						        	<h3>Cheverolet SUV Car</h3>
						        	<p class="mb-0 rated">
						        		<span>rated:</span>
						        ...
						        <td class="price">
						        	...
						        	<div class="price-rate">
							        	<h3>
							        		<span class="num"><small class="currency">rs</small> 10</span>
							        		<span class="per">/per hour</span>
							        	</h3>
							        	<span class="subheading">$3/hour fuel surcharges</span>
							        </div>
						        ...
						        <td class="price">
						        	...
						        	<div class="price-rate">
							        	<h3>
							        		<span class="num"><small class="currency">rs</small> 15</span>
							        		<span class="per">/per day</span>
							        	</h3>
							        	<span class="subheading">$3/hour fuel surcharges</span>
							        </div>
						      ...
						      <tr class="">
						      	<td class="car-image"><div class="img" style="background-image:url(images/cy6.jpg);"></div></td>
						        <td class="product-name">
						        	<h3>Cheverolet SUV Cycle</h3>
						        	<p class="mb-0 rated">
						        		<span>rated:</span>
						        ...
						        <td class="price">
						        	...
						        	<div class="price-rate">
							        	<h3>
							        		<span class="num"><small class="currency">rs</small> 13</span>
							        		<span class="per">/per day</span>
							        	</h3>
							        	<span class="subheading">$3/hour fuel surcharges</span>
							        </div>
